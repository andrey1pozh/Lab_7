...
public class DatabaseHandler {
    ...
    public PreparedStatement getPreparedStatement(String sqlStatement, boolean generateKeys) throws SQLException {
        Outputer.println("getPreparedStatement(DatabaseHandler)");
        ...
        try {
            ...
            Outputer.println("Подготовлен SQL запрос '" + sqlStatement + "'.");
            return preparedStatement;
        } catch (SQLException exception) {
            Outputer.println("Произошла ошибка при подготовке SQL запроса '" + sqlStatement + "'.");
    ...
    public void closePreparedStatement(PreparedStatement sqlStatement) {
        Outputer.println();
        Outputer.println("closePreparedStatement(DatabaseHandler)");
        if (sqlStatement == null) return;
        try {
            sqlStatement.close();
            Outputer.println("Закрыт SQL запрос '" + sqlStatement + "'.");
        } catch (SQLException exception) {
            Outputer.println("Произошла ошибка при закрытии SQL запроса '" + sqlStatement + "'.");
        }
    }
    ...
    public void closeConnection() {
        Outputer.println("closeConnection(DatabaseHandler)");
    ...
    public void setCommitMode() {
        Outputer.println("setCommitMode(DatabaseHandler)");
        try {
            if (connection == null) throw new SQLException();
            connection.setAutoCommit(false);
        } catch (SQLException exception) {
            Outputer.println("Произошла ошибка при установлении режима транзакции базы данных!");
        }
    }
    ...
    public void setNormalMode() {
        Outputer.println("setNormalMode(DatabaseHandler)");
        try {
            if (connection == null) throw new SQLException();
            connection.setAutoCommit(true);
        } catch (SQLException exception) {
            Outputer.println("Произошла ошибка при установлении нормального режима базы данных!");
        }
    }
     ...
     */
    public void commit() {
        Outputer.println("commit(DatabaseHandler)");
        try {
            if (connection == null) throw new SQLException();
            connection.commit();
        } catch (SQLException exception) {
            Outputer.println("Произошла ошибка при подтверждении нового состояния базы данных!");
        }
    }
    ...
    public void rollback() {
        Outputer.println("rollback(DatabaseHandler)");
        try {
            if (connection == null) throw new SQLException();
            connection.rollback();
        } catch (SQLException exception) {
            Outputer.println("Произошла ошибка при возврате исходного состояния базы данных!");
        }
    }
    ...
    public void setSavepoint() {
        Outputer.println("setSavepoint(DatabaseHandler)");
        try {
            if (connection == null) throw new SQLException();
            connection.setSavepoint();
        } catch (SQLException exception) {
            Outputer.println("Произошла ошибка при сохранении состояния базы данных!");
        }
    }
}
